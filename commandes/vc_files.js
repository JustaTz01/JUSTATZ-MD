...
zokou({ nomCom: 'group',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*Tap Here To Join Our What's app Group* https://chat.whatsapp.com/FohMUMLEDGt1pNJA9St1bo`) 
...
zokou({ nomCom: 'update',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_JUSTATZ MD is running on its latest vision_*`) 
